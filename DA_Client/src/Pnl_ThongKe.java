...
public class Pnl_ThongKe extends javax.swing.JPanel {
    ...
    public Pnl_ThongKe(Users u, int n) {
//        this.user = Session.user;
//        list = new ArrayList<ResultExam>();
//        this.n = 4 ;
//        try {
...
//            Logger.getLogger(Pnl_ThongKe.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        JFreeChart jfc = this.createChart(createDataset(list, n));
//        frame = new ChartFrame("Biểu đồ", jfc);
//        frame.setSize(600, 400);
//        this.add(frame.getChartPanel());
//        this.setSize(600, 350);
    }

//    ChartFrame getChart(){
//        JFreeChart jfc = this.createChart(createDataset(list, n));
//        ChartFrame cf = new ChartFrame("Biểu đồ", jfc); 
//        return cf;
//    }
...
// customise the renderer...
    ...
    private void jTableMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseReleased
        // TODO add your handling code here:         Long id;         try {             id = Main.client.getIDTable(jTMonHoc);         } catch (Exception ex) {             id = 1L;         }         if (!id.equals("")) {             try {                 Subject s = Cl_Client.c.getSubjectByID(id);                 txtIdMonHoc.setText(s.getSubjecId() + "");                 txtTenMonHocU.setText(s.getSubjectName());                 txtMoTaU.setText(s.getSubjectDescription());                 Users u = Cl_Client.c.getUserByID(s.getUserID());                 txtNguoiTao.setText(u.getUserID() + "");                 txtUserName.setText(u.getUserName());                 if (s.getSubjectState()) {                     cbxTrangThaiU.setSelected(true);                 } else {                     cbxTrangThaiU.setSelected(false);                 }                 txtNgayTaoU.setText(s.getDateCreate());              } catch (RemoteException ex) {                 Logger.getLogger(Pnl_MonHoc.class.getName()).log(Level.SEVERE, null, ex);             }         }     }//GEN-LAST:event_jTableMouseReleased
    }
